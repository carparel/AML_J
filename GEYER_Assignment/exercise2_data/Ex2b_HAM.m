...
struct_mRFX_HAM_symetric_feedback_low = mRFX;
save('struct_mRFX_HAM_symetric_feedback_low.mat','struct_mRFX_HAM_symetric_feedback_low'); 

%% Asymetric feedback low noise
struct_mRFX_HAM_asymetric_feedback_low = mRFX;
save('struct_mRFX_HAM_asymetric_feedback_low.mat','struct_mRFX_HAM_asymetric_feedback_low'); 

%% Symetric stimulation low noise
struct_mRFX_HAM_symetric_stimulation_low = mRFX;
save('struct_mRFX_HAM_symetric_stimulation_low.mat','struct_mRFX_HAM_symetric_stimulation_low'); 

%% Asymetric stimulation low noise
struct_mRFX_HAM_asymetric_stimulation_low = mRFX;
save('struct_mRFX_HAM_asymetric_stimulation_low.mat','struct_mRFX_HAM_asymetric_stimulation_low'); 