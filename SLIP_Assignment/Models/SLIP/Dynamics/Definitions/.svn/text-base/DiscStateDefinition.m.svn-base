...
function [discStateVec, discStateNames, discStateIndices] = DiscStateDefinition()
    ...
    discState.phase  = 1; % ['1','2','3'] The current phase of the model  (flight = 1) (stance = 2) (flight after stance = 3)
    discState.contPt = 0; % [l_0]     Horizontal position of the last ground contact
